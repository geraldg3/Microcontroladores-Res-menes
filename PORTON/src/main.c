...
//Nombre: Geraldo Jimenez
//Matricula: 2022-0853
//Proyecto: PORTON AUTOMATICO
//
//
#include <stdio.h> // Libreria estandar de entrada/salida en C
#include <stdlib.h>
#include <freertos/FreeRTOS.h> // Librería FreeRTOS para el manejo de delays
#include <freertos/task.h>
#include <driver/gpio.h> // Libreria para el manejo de GPIO
#include <freertos/timers.h> // Libreria para el uso de timers
#include "esp_log.h" // Libreria para el logging de ESP-IDF
...
esp_err_t INTERRUPCION_50MS(void); // Manejar interrupciones de 50ms
esp_err_t SET_TIMER(void); // FPara configurar el timer
...
// Funcion para el estado de cierre
int Func_ESTADO_CERRANDO() {
...
// Funcion para el estado de cerrado
int Func_ESTADO_CERRADO() {
...
// Funcion para el estado de error
int Func_ESTADO_ERROR() {
    ESTADO_ANTERIOR = ESTADO_ACTUAL;
